<h2>修改公司信息 <button id="return" data-bind="click: usp.admin.corp.edit.goBack" class="button place-right primary"><span class="mif-keyboard-return "></span></button></h2>
<hr class="thin bg-grayLighter">
<form data-role="validator" data-hint-mode="hint" data-on-submit="return usp.admin.corp.edit.save()">
    <div class="grid padding20">
        ...
        <div class="row cells2">
            ...
            <div class="cell">
                ...
                <div class="input-control text full-size">
                    <div class="input-control text" data-locale="zhCN" data-role="datepicker">
...
<script src="/static/js/usp.admin.corp.edit.js"></script>
<script>
    $(function() {
        var id = '{{.Model.ID}}'
        usp.init()
        usp.admin.corp.edit.init(id)
    })
</script>