...
type OpenPlatformMsgKey struct {
	...
	Command    string    `orm:"column(Command);size(255);"`
	Matching   byte      `orm:"column(Matching);"`
...
func (this *OpenPlatformMsgKey) Add() (id int64, err error) {
	o := orm.NewOrm()
	id, err = o.Insert(this)
	return id, err
}

func (this *OpenPlatformMsgKey) Count(condation *orm.Condition) (int64, error) {
	o := orm.NewOrm()
...
func (this *OpenPlatformMsgKey) Update(cols ...string) (num int64, err error) {
	o := orm.NewOrm()
	if o.Read(this) == nil {
...
func (this *OpenPlatformMsgKey) Delete() (num int64, err error) {
	o := orm.NewOrm()
	num, err = o.Delete(this)
	return num, err
}

func (this *OpenPlatformMsgKey) Read(cols ...string) (*OpenPlatformMsgKey, error) {
	o := orm.NewOrm()
...
func (this *OpenPlatformMsgKey) GetAll(condation *orm.Condition, sort string) (models []OpenPlatformMsgKey) {
	o := orm.NewOrm()
	qs := o.QueryTable(this)
	if condation != nil {
		qs.SetCond(condation)
...
func (this *OpenPlatformMsgKey) Getlist(condation *orm.Condition, page int64, page_size int64, sort string) (models []orm.Params, count int64) {
	o := orm.NewOrm()
	qs := o.QueryTable(this)
	var offset int64
	if page <= 1 {
...
func (this *OpenPlatformMsgKey) Validation() (err error) {
