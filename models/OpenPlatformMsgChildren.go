...
func (this *OpenPlatformMsgChildren) Add() (id int64, err error) {
	o := orm.NewOrm()
	id, err = o.Insert(this)
	return id, err
}

func (this *OpenPlatformMsgChildren) Count(condation *orm.Condition) (int64, error) {
	o := orm.NewOrm()
...
func (this *OpenPlatformMsgChildren) Update(cols ...string) (num int64, err error) {
	o := orm.NewOrm()
	if o.Read(this) == nil {
...
func (this *OpenPlatformMsgChildren) Delete() (num int64, err error) {
	o := orm.NewOrm()
	num, err = o.Delete(this)
	return num, err
}

func (this *OpenPlatformMsgChildren) Read(cols ...string) (*OpenPlatformMsgChildren, error) {
	o := orm.NewOrm()
...
func (this *OpenPlatformMsgChildren) GetAll(condation *orm.Condition, sort string) (models []OpenPlatformMsgChildren) {
	o := orm.NewOrm()
	qs := o.QueryTable(this)
	if condation != nil {
		qs.SetCond(condation)
...
func (this *OpenPlatformMsgChildren) Getlist(condation *orm.Condition, page int64, page_size int64, sort string) (models []orm.Params, count int64) {
	o := orm.NewOrm()
	qs := o.QueryTable(this)
	var offset int64
	if page <= 1 {
...
func (this *OpenPlatformMsgChildren) Validation() (err error) {
