...
func init() {
	orm.RegisterModel(new(SysCorpFeeType))
}

type SysCorpFeeType struct {
...
func (this *SysCorpFeeType) TableName() string {
	return "SysCorpFeeType"
}

func (this *SysCorpFeeType) Add() (id int64, err error) {
	o := orm.NewOrm()
	id, err = o.Insert(this)
	return id, err
}

func (this *SysCorpFeeType) Count(condation *orm.Condition) (int64, error) {
	o := orm.NewOrm()
...
func (this *SysCorpFeeType) Update(cols ...string) (num int64, err error) {
	o := orm.NewOrm()
	if o.Read(this) == nil {
...
func (this *SysCorpFeeType) Delete() (num int64, err error) {
	o := orm.NewOrm()
	num, err = o.Delete(this)
	return num, err
}

func (this *SysCorpFeeType) Read(cols ...string) (*SysCorpFeeType, error) {
	o := orm.NewOrm()
...
func (this *SysCorpFeeType) GetAll(condation *orm.Condition, sort string) (models []SysCorpFeeType) {
	o := orm.NewOrm()
	qs := o.QueryTable(this)
	if condation != nil {
		qs.SetCond(condation)
...
func (this *SysCorpFeeType) Getlist(condation *orm.Condition, page int64, page_size int64, sort string) (models []orm.Params, count int64) {
	o := orm.NewOrm()
	qs := o.QueryTable(this)
	var offset int64
	if page <= 1 {
...
func (this *SysCorpFeeType) Validation() (err error) {
