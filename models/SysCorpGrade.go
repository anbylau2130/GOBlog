...
func init() {
	orm.RegisterModel(new(SysCorpGrade))
}

type SysCorpGrade struct {
...
func (this *SysCorpGrade) TableName() string {
	return "SysCorpGrade"
}

func (this *SysCorpGrade) Add() (id int64, err error) {
	o := orm.NewOrm()
	id, err = o.Insert(this)
	return id, err
}

func (this *SysCorpGrade) Count(condation *orm.Condition) (int64, error) {
	o := orm.NewOrm()
...
func (this *SysCorpGrade) Update(cols ...string) (num int64, err error) {
	o := orm.NewOrm()
	if o.Read(this) == nil {
...
func (this *SysCorpGrade) Delete() (num int64, err error) {
	o := orm.NewOrm()
	num, err = o.Delete(this)
	return num, err
}

func (this *SysCorpGrade) Read(cols ...string) (*SysCorpGrade, error) {
	o := orm.NewOrm()
...
func (this *SysCorpGrade) GetAll(condation *orm.Condition, sort string) (models []SysCorpGrade) {
	o := orm.NewOrm()
	qs := o.QueryTable(this)
	if condation != nil {
		qs.SetCond(condation)
...
func (this *SysCorpGrade) Getlist(condation *orm.Condition, page int64, page_size int64, sort string) (models []orm.Params, count int64) {
	o := orm.NewOrm()
	qs := o.QueryTable(this)
	var offset int64
	if page <= 1 {
...
func (this *SysCorpGrade) Validation() (err error) {
