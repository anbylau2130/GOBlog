...
func init() {
	orm.RegisterModel(new(SysOperatorSupplier))
}

type SysOperatorSupplier struct {
	ID         int64     `orm:"column(ID);default();index;"`
	Operator   int64     `orm:"column(Operator);default();"`
	Supplier   int64     `orm:"column(Supplier);default();"`
...
func (this *SysOperatorSupplier) TableName() string {
	return "SysOperatorSupplier"
}
